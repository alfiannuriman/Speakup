...
class NewsCardProfile extends StatefulWidget {
  ...
  final bool selected;
  @override
  NewsCardListProfile createState() {
    return NewsCardListProfile();
  }
}
...
class NewsCardListProfile extends State<NewsCardProfile> {
  Color _loveButtonColor = Colors.black;
  bool liked;
  @override
  Widget build(BuildContext context) {
