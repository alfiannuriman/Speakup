    ...
    return Scaffold(
      ...
      body: DefaultTextStyle(
        ...
        child: FutureBuilder<user>(
          future:
              fetchGetUser(), // a previously-obtained Future<String> or null
          builder: (context, snapshot) {
            ...
            if (snapshot.hasData) {
              if (snapshot.data.code == 200) {
                ...
                _valGender = (dataUser.gender == null || dataUser.gender == '')
                    ? "M"
                    : dataUser.gender;
                _fullnameController.text =
                    dataUser.full_name == null ? "" : dataUser.full_name;
                _teleponController.text =
                    dataUser.telepon == null ? "" : dataUser.telepon;
                _birthplaceController.text =
                    dataUser.birth_place == null ? "" : dataUser.birth_place;
                _birthdateController.text =
                    dataUser.birth_date == null ? null : dataUser.birth_date;
